...
model2_reg = joblib.load('model2_xgb_reg.pkl')
model2_cls = joblib.load('model2_rf_cls.pkl')
...
# --- User input ---
min_val = st.number_input('Enter Min value', min_value=0.0, step=0.01)
mid_val = st.number_input('Enter Mid value', min_value=0.0, step=0.01)
max_val = st.number_input('Enter Max value', min_value=0.0, step=0.01)
